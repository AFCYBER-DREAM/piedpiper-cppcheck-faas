...
expected=(
    ...
    "[cpp_project/src/chrome_content_renderer_client.cc:933] -> [cpp_project/src/chrome_content_renderer_client.cc:932] -> [cpp_project/src/chrome_content_renderer_client.cc:964]: (style) Finding the same expression on both sides of an operator is suspicious and might indicate a cut and paste or logic error. Please examine this code carefully to determine if it is correct."
    "[cpp_project/src/chrome_content_renderer_client.cc:931] -> [cpp_project/src/chrome_content_renderer_client.cc:933] -> [cpp_project/src/chrome_content_renderer_client.cc:965]: (style) Finding the same expression on both sides of an operator is suspicious and might indicate a cut and paste or logic error. Please examine this code carefully to determine if it is correct."
